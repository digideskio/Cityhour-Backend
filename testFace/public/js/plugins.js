...
!function($) {
    ...
    Checkbox.prototype = {
        ...
        checkChecked: function() {
            ...
            if (this.$element.attr('id') == 'price_check' || this.$element.attr('id') == 'bonus_check' || this.$element.attr('id') == 'month_check') {
                if (this.$element.is(':checked')) {
                    this.$element.parents(".finCheWrapper").parent().parent().find("input[type='text']").prop('disabled', false);
                }
                else {
                    this.$element.parents(".finCheWrapper").parent().parent().find("input[type='text']").prop('disabled', true);
                }
            }
