                 ...
                 FROM   notifications n
                        ...
                        LEFT JOIN user_jobs j
                               ON u.id = j.user_id
                                  ...
                                  AND j.type = 0
                 WHERE  n.to = $user_id
                    AND n.type IN ( 0, 1, 2, 7, 8, 12 ) and n.status != 1
                    $id
                 GROUP  BY n.id
                 order by n.id desc
                 limit 50
                 ...
                 FROM   notifications n
                        ...
                        LEFT JOIN user_jobs j
                               ON u.id = j.user_id
                                  AND j.current = 1
                                  AND j.type = 0
                 WHERE n.to = $user_id AND n.type IN ( 3, 4, 5, 6, 9, 10, 11 ) and n.status != 1
                    $id
                 GROUP  BY n.id
                 order by n.id desc
                 limit 50
                 ...
                 FROM   notifications n
                        ...
                        LEFT JOIN user_jobs j
                               ON u.id = j.user_id
                                  AND j.current = 1
                                  AND j.type = 0
                 WHERE  n.from = $user_id and n.type in (3,13) and n.status != 2
                    $id
                 GROUP  BY n.id
                 order by n.id desc
                 limit 50
